...
def predict_note_authentication(Store, Dept, IsHoliday, Temperature, Fuel_Price, Size, day, year,
    ...
    """
    loaded_model = pickle.load(open(r'C:\Users\dbda-lab\Downloads\Streamlit\Streamlit\CatBoostRegressor','rb'))
...
def main():
    ...
    chart_data = pd.read_csv(r'C:\Users\dbda-lab\Downloads\Streamlit\Streamlit\data_for_chart.csv')
    train_data = pd.read_csv(r'C:\Users\dbda-lab\Downloads\Streamlit\Streamlit\train.csv')
